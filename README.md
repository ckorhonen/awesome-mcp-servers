...
- 🚇 [mta-mcp](https://github.com/ckorhonen/mta-mcp) - Real-time NYC subway arrivals, service alerts, station search, and trip planning for all 496 stations. Powered by live MTA GTFS-RT feeds. Remote MCP endpoint with one-click Claude Desktop extension.
